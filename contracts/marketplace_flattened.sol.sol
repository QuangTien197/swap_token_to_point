...
// File: contracts/marketplace29122023.sol
...
contract NFTMarketplace is ERC721URIStorage, IERC721Receiver {
    ...
    event UnlistNFT(address indexed _owner, address _seller, uint256 _tokenId);
    event updatePriceNFT(address _seller, uint256 _tokenId, uint256 _price);

    constructor() ERC721("T-REX", "TREX") {
    ...
    function updateListPriceNFT(uint256 tokenId, uint256 price) public {
        ...
        require(
            price > listingPrice,
            "New price must be greater than listing price"
        );
        idToMarketItem[tokenId].price = price;
        emit updatePriceNFT(msg.sender, tokenId, price);
    }
    ...
    function unlistNFT(uint256 tokenId) public {
        ...
        _itemsSold.increment();
        _transfer(address(this), msg.sender, tokenId);
        emit UnlistNFT(address(this), msg.sender, tokenId);
    }
